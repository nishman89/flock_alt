...
function initDesktop() {
  ...
  const svgs = {
    flocks:    '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',
    ...
    myflocks:  '<path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>',
    myevents:  '<path d="M8 6h13M8 12h13M8 18h13M3 6h.01M3 12h.01M3 18h.01"/>',
  ...
  sidebar.innerHTML = `
    ...
    <nav class="sb-nav">
      ${navLink('home.html',      'flocks',    'Flocks',    svgs.flocks)}
      ${navLink('events.html',    'events',    'Events',    svgs.events)}
      ${navLink('my-flocks.html', 'my-flocks', 'My Flocks', svgs.myflocks)}
      ${navLink('my-events.html', 'my-events', 'My Events', svgs.myevents)}
